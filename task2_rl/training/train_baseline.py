...
from generative_opponent import GenerativeOpponentAgent
from log_results import save_results   


class LearningAgent(RandomAgent):
    """
    Wrapper that allows a DQN agent to interact with Chef's Hat Gym
    """
...
async def main():
    ...
    opponents = [
        GenerativeOpponentAgent("GEN_OPP", room.room_dir),
    ...
    save_results("dqn_vs_generative", room.final_scores)
